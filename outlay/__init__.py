"""Outlay — roadmap-anchored AI spend governance (Phase 0 prototype).

Sibling product to ModelPilot. Where ModelPilot answers *"cheapest model that's
good enough per request"*, Outlay answers *"how much should this body of
...
runs with no new dependencies. Run `python -m outlay.cli` for the demo
