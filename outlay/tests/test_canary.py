...
from outlay.policy import PolicyMode, build_policy
from outlay.recommend import recommend
from outlay.shadow import ClassGraduation
...
def test_graduation_flips_policy_to_enforce():
    ...
    from outlay.shadow import promote as promote_policy
