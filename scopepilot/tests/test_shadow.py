...
from scopepilot.policy import PolicyMode, PolicyResolver, build_policy
from scopepilot.recommend import recommend
from scopepilot.shadow import (
    ShadowLedger,
    ShadowObserver,
    graduation_report,
    make_observer,
...
def test_gateway_observer_seam():
    ...
    loaded = gateway._load_observer("scopepilot.shadow:make_observer")
