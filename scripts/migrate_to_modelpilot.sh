...
cp "$SRC"/PRODUCT_DESIGN.md "$SRC"/ROUTER_TUNING_PLAN.md "$SRC"/SAVINGS_DASHBOARD.md \
   ...
   "$SRC"/ICP.md "$SRC"/PROSPECTS.md "$SRC"/PERSONAS_USECASES.md "$SRC"/SELF_OPTIMIZE_EVAL.md "$SRC"/FLEET_LEARNING.md "$SRC"/ENTITY_FORMATION.md "$SRC"/MARKET_STUDY_2026.md "$SRC"/pilot_tracker.csv "$WORK/internal/"
