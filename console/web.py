...
def _outlay_connect(error: str = "", collapsed: bool = False) -> str:
    ...
    return f"""<details class=card{open_attr}>{summary}
      ...
      <p class=muted style="margin:.2em 0 1em">Paste your tracker export (GitHub Issues JSON) and your AI-usage
        export — <b>Anthropic usage JSON</b>, <b>AWS Bedrock</b>, or <b>Google Vertex</b> logs (auto-detected).
      ...
      <div style="display:grid;gap:12px">
        ...
        <label class=fld><span>AI usage — Anthropic usage JSON <span class=muted style="font-weight:400">or AWS Bedrock / Google Vertex logs</span></span>
