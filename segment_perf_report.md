...
| Midship | extraction | sonnet-4-6 | 0.75 | · | 0% | Parse this purchase-order table into rows of {sku, qty… |
...
- **Classified but held at baseline (13) — quality-protected (hard tasks).** Confirm these *should* stay (e.g., debugging, refactors, long-form drafting):
...
- query =…"
    ...
    - _Doc extraction / Midship_ (extraction): "Parse this purchase-order table into rows of {sku, qty, unit…"
