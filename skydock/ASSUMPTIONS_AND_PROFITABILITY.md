...
$200 weighted ASP, with **$2.28M cash position remaining at M18 + $75K
accrued founder deferred comp liability** (founder comp under Option C
hybrid: $150K cash + $50K/yr deferred, payable from seed close
proceeds; total founder comp $200K/yr at market rate but $50K deferred
preserves cash through pre-seed phase). The business is self-sustaining
at CFP. **The seed round becomes optional** — needed for geographic
expansion + product growth, not for survival.
